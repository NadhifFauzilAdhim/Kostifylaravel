...
<div class="container-fluid">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Create New Post</h5>
        <div class="card">
          <div class="card-body">
            <form method="POST" action="/dashboard/posts" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('placename') is-invalid @enderror" id="placename" name="placename" placeholder="Nama Tempat Tinggal anda" value="{{ old('placename') }}" required autofocus>
                @error('placename')
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="link post akan tampil disini" value="{{ old('slug') }}" required >  
                @error('slug')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('available') is-invalid @enderror" id="available" name="available" placeholder="Jumlah Kamar Tersedia" required >  
                @error('available')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('price') is-invalid @enderror" id="price" name="price" placeholder="Harga yang anda tawarkan" required>  
                @error('price')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('location') is-invalid @enderror" id="location" name="location" placeholder="Masukan alamat lengkap">  
                @error('location')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="mb-3">
                <div class="container mt-5">
                  <div class="card">
                      <div class="card-body">
                        <label for="image" class="form-label">Upload Gambar Poster (max 2 mb)</label>
